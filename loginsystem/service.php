...
$services = $conn->query("SELECT * FROM services WHERE status = '0'");
...
<div class="container-fluid services py-5 my-5">
    <div class="container py-5">
        ...
        <div class="container pb-5">
            <div class="row">
                <?php
                // Loop through the services results and display each service
                        ...
                        <div class="card-deck">
                            <div class="card">
                                <img class="card-img-top" style="height:270px;"
                                     src="admin/images/services/<?php echo htmlspecialchars($row['img']); ?>" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <b>
                                    ...
                                    <p class="card-text"><?php echo htmlspecialchars($row['short']); ?></p>
                                </div>
                                <div class="card-footer">
                                    <div class="link">
                                        <a href="single-service.php?id=<?php echo $row['id']; ?>" class="readmore-link">
