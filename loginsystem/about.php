...
<html lang="en">
  ...
  <body>
        ...
        <nav class="navbar navbar-dark navbar-expand-lg py-0">
          <a href="index.html" class="navbar-brand">
            <h1 class="text-white fw-bold d-block">
              Edgelink<span class="text-secondary">Services</span>
            </h1>
          </a>
          <button
            type="button"
      ...
      <div class="container py-5">
        <div class="row g-5">
          ...
          >
            ...
            <p>
              At Edgelink Consultancy, we are committed to empowering businesses through expert consultancy services and innovative solutions. Our team of experienced professionals brings together deep industry knowledge and cutting-edge technology to help your organization navigate complex challenges and unlock new opportunities. From strategic planning to implementation, we partner with you every step of the way to ensure your vision becomes reality.
            </p>
            <p class="mb-4">
              We pride ourselves on providing personalized, data-driven insights that drive sustainable growth and success. Our collaborative approach fosters creativity, and our dedication to unparalleled customer support sets us apart. Whether you are looking to optimize operations, embrace digital transformation, or explore new markets, Edgelink Consultancy is your trusted partner on the journey to success.
            </p>
            <a
              href=""
    ...
    <?php
// Fetch About Us details from the database
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                <h5 class="text-primary">About Us</h5>
                <h1 class="mb-4"><?php echo htmlspecialchars($about['title']); ?></h1>
          ...
          <div class="rounded team-item">
            <div class="team-content">
              <div class="team-img-icon">
                ...
                <div class="team-name text-center py-3">
                  <h4 class="">Renuka Rahalkar</h4>
                  <p class="m-0">HR and Finance</p>
                </div>
                <div class="team-icon d-flex justify-content-center pb-4">
                  <a
                    class="btn btn-square btn-secondary text-white rounded-circle m-1"
          ...
          <div class="rounded team-item">
            <div class="team-content">
              <div class="team-img-icon">
                ...
                <div class="team-name text-center py-3">
                  <h4 class="">Srishti Kumar</h4>
                  <p class="m-0">Technical Head</p>
                </div>
                <div class="team-icon d-flex justify-content-center pb-4">
                  <a
                    class="btn btn-square btn-secondary text-white rounded-circle m-1"
          ...
          <div class="rounded team-item">
            <div class="team-content">
              <div class="team-img-icon">
                ...
                <div class="team-name text-center py-3">
                  <h4 class="">Jay Mehta</h4>
                  <p class="m-0">Documentation Head</p>
                </div>
                <div class="team-icon d-flex justify-content-center pb-4">
                  <a
                    class="btn btn-square btn-secondary text-white rounded-circle m-1"
      ...
      <div class="container pt-5 pb-4">
        <div class="row g-5">
          <div class="col-lg-3 col-md-6">
            ...
            <p class="mt-4 text-light">Consultancy Services LLP</p>
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <div class="mt-4 d-flex flex-column help-link">
              ...
              >
              <a href="" class="mb-2 text-white"
                ><i class="fas fa-angle-right text-secondary me-2"></i>FAQs</a
              >
              <a href="" class="mb-2 text-white"
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <div class="text-white mt-4 d-flex flex-column contact-link">
              <a href="#" class="pb-3 text-light border-bottom border-primary"
                ><i class="fas fa-map-marker-alt text-secondary me-2"></i> M3
                Technologies , Bavdhan , Pune</a
              >
          ...
          <div class="col-md-6 text-center text-md-start">
            <span class="text-light"
              ><a href="#" class="text-secondary"
                ><i class="fas fa-copyright text-secondary me-2"></i>Edgelink</a
